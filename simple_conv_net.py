...
class SimpleConvNet:
    def __init__(self, input_dim=(1, 28, 28), conv_param={'filter_num': 30, 'filter_size': 5, 'stride': 1, 'pad': 0}, hidden_size=100, output_size=10, weight_init_std=0.01) -> None:
    ...
    def accuracy(self, x: np.ndarray, t: np.ndarray, batch_size=100):
        acc = 0.0
        if t.ndim != 1:
